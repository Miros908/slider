class FunctionSlider {
  constructor() {
    ...
    this.sliderCoordinate = 0;
    this.startIndex = 0;
  }

  createSlider(selector, options = {}) {
    let sliderCounter = functions.getSliderCounter();
    let sliderCoordinate = functions.getSliderCoordinate();
    let startIndex = functions.getStartIndex();

    options = Object.assign({}, functions.getOptions(), options);
